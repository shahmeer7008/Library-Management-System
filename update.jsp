...
<h1 style="color:white; text-align: center; align-items: center;">Update Book</h1>
<form method="POST" action="Update">
    <label>Old Name: <input type="text" name="oldname" required></label>
    <label>New Name: <input type="text" name="newname" required></label> 
    <label>New AuthorName: <input type="text" name="nauthname" required></label>
